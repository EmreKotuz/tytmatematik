...
import kotlinx.android.synthetic.main.activity_bolme_bolunebilme.*

class bolmeBolunebilme : AppCompatActivity() {
    private var mAdView: AdView? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_bolme_bolunebilme)

        bölmeGeceModu.setOnClickListener {
            if (bölmeGeceModu.isChecked){
                bolmeEkrann.setBackgroundColor(Color.parseColor("#FFC7B87F"))
